...
def schedule_clear(lane_number):
    ...
    if lane_number == 0:
        ...
        timer0 = threading.Timer(3, clear_function, args=[0])
        timer0.start()
    ...
    if lane_number == 1:
        ...
        timer1 = threading.Timer(3, clear_function, args=[1])
        timer1.start()
    ...
    if lane_number == 2:
        ...
        timer2 = threading.Timer(3, clear_function, args=[2])
        timer2.start()
    ...
    if lane_number == 3:
        ...
        timer3 = threading.Timer(3, clear_function, args=[3])
        timer3.start()
